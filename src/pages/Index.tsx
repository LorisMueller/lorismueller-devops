    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="p-6 text-center bg-card border-border/20 card-hover">
              ...
              <p className="text-muted-foreground">{t('stats.certified')}</p>
            </Card>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">
              {t('featured.title').split(' ')[0]} <span className="text-gradient">{t('featured.title').split(' ')[1]}</span>
            </h2>
      ...
      <section className="py-20 bg-gradient-to-r from-primary/10 to-secondary/10">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-4">
            {t('cta.title').split('Amazing?')[0]}<span className="text-gradient">Amazing?</span>
          </h2>
